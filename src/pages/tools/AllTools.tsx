import { Card, Button, Skeleton, message, Avatar, Tooltip } from "antd";
...
import { ToolDto } from "../../redux/tools/store";
...
const ToolsGrid = () => {
  ...
  const handleEdit = async (tool: ToolDto) => {
    dispatch(setEditingTool(true));
    dispatch(
      setCreateTool({
        ...createTool,
        name: tool.name,
        ...
        toolType: tool.toolType==null?"Python":tool.toolType,
